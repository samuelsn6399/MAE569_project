function [deltaV,deltaV1,deltaV2_min,deltaV3_min] = Jupiter2EarthV3_func(jupiter_dDate1, ToF12_day)
...
% jupiter_dDate1 = datetime(2048,12,25,11,58,00);
% earth_aDate2 = datetime(2051,06,15,11,58,00);
% jupiter_dDate1 = datetime(2050,04,12,11,58,00);
load("J2000.mat")

earth_aDate2 = jupiter_dDate1+ToF12_day;
...
% T_geocentricFlyby = sqrt(4*pi^2*a_s3^3);
